# ASTRA Dashboard — 파란새_v2 (2026-09-19)

실행만 하려면 Releases의 **bluebird-v2**에서 실행 ZIP(파란새_v2)을 받으세요. 소스로 실행하려면 v1.0.0 Release의 `ASTRA-demo-data-v1.zip`을 `downloads/`에 넣고 아래처럼 실행합니다.
